...
constexpr HelloReplay::HelloReplay(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : message_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
struct HelloReplayDefaultTypeInternal {
  constexpr HelloReplayDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~HelloReplayDefaultTypeInternal() {}
  union {
    HelloReplay _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT HelloReplayDefaultTypeInternal _HelloReplay_default_instance_;
}  // namespace test
...
const uint32_t TableStruct_helloWorld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::test::HelloReplay, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::test::HelloReplay, message_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::test::HelloRequest)},
  { 7, -1, -1, sizeof(::test::HelloReplay)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::test::_HelloRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::test::_HelloReplay_default_instance_),
};
...
const char descriptor_table_protodef_helloWorld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "loRequest\032\021.test.HelloReplayb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_helloWorld_2eproto = {
  false, false, 156, descriptor_table_protodef_helloWorld_2eproto, "helloWorld.proto", 
...
class HelloReplay::_Internal {
 public:
};

HelloReplay::HelloReplay(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  if (!is_message_owned) {
  ...
  // @@protoc_insertion_point(arena_constructor:test.HelloReplay)
}
HelloReplay::HelloReplay(const HelloReplay& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:test.HelloReplay)
}

inline void HelloReplay::SharedCtor() {
message_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  message_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
HelloReplay::~HelloReplay() {
  // @@protoc_insertion_point(destructor:test.HelloReplay)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void HelloReplay::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  message_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void HelloReplay::ArenaDtor(void* object) {
  HelloReplay* _this = reinterpret_cast< HelloReplay* >(object);
  (void)_this;
}
void HelloReplay::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void HelloReplay::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void HelloReplay::Clear() {
// @@protoc_insertion_point(message_clear_start:test.HelloReplay)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* HelloReplay::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "test.HelloReplay.message"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* HelloReplay::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:test.HelloReplay)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:test.HelloReplay)
  return target;
}

size_t HelloReplay::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:test.HelloReplay)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData HelloReplay::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    HelloReplay::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*HelloReplay::GetClassData() const { return &_class_data_; }

void HelloReplay::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<HelloReplay *>(to)->MergeFrom(
      static_cast<const HelloReplay &>(from));
}


void HelloReplay::MergeFrom(const HelloReplay& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:test.HelloReplay)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void HelloReplay::CopyFrom(const HelloReplay& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:test.HelloReplay)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool HelloReplay::IsInitialized() const {
  return true;
}

void HelloReplay::InternalSwap(HelloReplay* other) {
  using std::swap;
  auto* lhs_arena = GetArenaForAllocation();
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata HelloReplay::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_helloWorld_2eproto_getter, &descriptor_table_helloWorld_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::test::HelloReplay* Arena::CreateMaybeMessage< ::test::HelloReplay >(Arena* arena) {
  return Arena::CreateMessageInternal< ::test::HelloReplay >(arena);
}
